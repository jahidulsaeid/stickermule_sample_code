...
const SearchProduct: React.FC<SearchProductProps> = ({ item }) => {
  ...
  return (
    ...
    >
      <div className="relative flex w-16 md:w-24 h-16 md:h-24 rounded-md overflow-hidden bg-gray-200 flex-shrink-0 cursor-pointer me-4">
        <Image
          src={
      ...
      <div className="flex flex-col w-full overflow-hidden">
        ...
        <div className="text-heading font-semibold text-sm">
          ...
          //     discountPriceClassName="ps-2 text-gray-400 font-normal"
          //   />
          // ) : 
          (
            <>
