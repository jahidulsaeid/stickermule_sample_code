    ...
    >
      ...
      {closeable && (
        <button
          ...
          onClick={onClose}
          title="Close alert"
          className="-me-0.5 -mt-3 flex items-center justify-center rounded-full flex-shrink-0 w-6 h-6 text-red-500 absolute end-3 top-1/2 transition-colors duration-200 hover:bg-gray-200 hover:bg-opacity-50 focus:outline-none focus:bg-gray-200 focus:bg-opacity-50"
        >
