  ...
  exclusiveData: [
    {
      ...
      image:
        'https://chawkbazar.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fexclusive%2Fwomen.png&w=640&q=75',
      exclusiveName: 'New Year',
    },
    {
      id: 2,
      ...
      image:
        'https://chawkbazar.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fexclusive%2Fmen.png&w=640&q=75',
...
const HomeSlider: React.FC<Props> = () => {
  return (
    <div
      className={`rounded-md overflow-hidden lg:block mb-12 md:mb-14 xl:mb-16 mx-auto max-w-[1920px]`}
    >
